    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.Box1}>
            <Text style={{color:'white', fontSize:20, fontWeight: 'bold',}}>Para você</Text>
              
            <View style={styles.Box2}> 
              <View style={styles.circule}><FontAwesome5 name="car" size={60} color="black"/></View>
              <View style={styles.circule}><MaterialCommunityIcons name="package-variant-closed" size={60} color="black" /></View>
              <View style={styles.circule}><MaterialCommunityIcons name="calendar-clock" size={60} color="black" /></View>
            </View>
        </View>
        <Mapa />
